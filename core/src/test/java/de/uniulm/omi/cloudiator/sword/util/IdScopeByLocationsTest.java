...
public class IdScopeByLocationsTest {
  ...
  @Test
  public void testFromScopeAndId() throws Exception {
  ...
  public void testFromScopeAndIdRejectsNullId() {
  ...
  @Test(expected = NullPointerException.class)
  public void testFromIdRejectsNullId() {
    IdScopeByLocations.from(null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testFromIdRejectsEmptyId() {
