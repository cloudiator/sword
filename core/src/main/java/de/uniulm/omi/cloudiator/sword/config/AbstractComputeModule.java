...
public abstract class AbstractComputeModule extends AbstractModule {
  ...
  @Provides
  final Optional<PublicIpExtension> provideFloatingIpService(Injector injector) {
    return publicIpService(injector);
  }

  @Provides
  final Optional<KeyPairExtension> provideKeyPairService(Injector injector) {
  ...
  @Memoized
  @Singleton
  final Supplier<Set<Location>> provideMemoizedLocationSupplier(
  ...
  /**
   * Extension point for the {@link GetStrategy} for {@link VirtualMachine}s Defaults to {@link
   * de.uniulm.omi.cloudiator.sword.strategy.DefaultGetStrategy.DefaultVirtualMachineGetStrategy}
   *
  ...
  /**
   * Extension point for the {@link GetStrategy} for {@link Image}s Defaults to {@link
   * de.uniulm.omi.cloudiator.sword.strategy.DefaultGetStrategy.DefaultImageGetStrategy}
   *
   * @return the strategy class to use.
   */
  ...
  /**
   * Extension point for the {@link GetStrategy} for {@link Location}s. Defaults to {@link
   * de.uniulm.omi.cloudiator.sword.strategy.DefaultGetStrategy.DefaultLocationGetStrategy}
   *
   * @return the strategy class to use.
   */
  ...
  /**
   * Extension point for the {@link GetStrategy} for {@link HardwareFlavor}s. Defaults to {@link
   * de.uniulm.omi.cloudiator.sword.strategy.DefaultGetStrategy.DefaultHardwareFlavorGetStrategy}
   *
   * @return the strategy class to use.
   */
