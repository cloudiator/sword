 ...
 */
public class TildeDelimitedIdScopedByCloudImpl implements IdScopedByCloud {

  private static final String DELIMITER = "~";
  private final String id;
  private final String cloudId;

  TildeDelimitedIdScopedByCloudImpl(String scopedId) {
  ...
  TildeDelimitedIdScopedByCloudImpl(String id, String cloudId) {
