...
public class SubregionToLocation implements OneWayConverter<Subregion, Location> {

  @Override
  public Location apply(Subregion subregion) {
    return LocationBuilder.newBuilder()
        .id(String.valueOf(subregion.getId()))
        .providerId(subregion.getName())
        .assignable(true)
