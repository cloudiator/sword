...
public class HealthCheckTcp {
  ...
  public HealthCheckTcp port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckTcp timeout(Integer timeout) {
  ...
  **/
  ...
  public HealthCheckTcp notificationTypes(List<DictionaryItem> notificationTypes) {
    this.notificationTypes = notificationTypes;
    return this;
  }

  public HealthCheckTcp addNotificationTypesItem(DictionaryItem notificationTypesItem) {
  ...
  **/
  ...
  public HealthCheckTcp notificationEventTypes(List<DictionaryItem> notificationEventTypes) {
    this.notificationEventTypes = notificationEventTypes;
    return this;
  }

  public HealthCheckTcp addNotificationEventTypesItem(DictionaryItem notificationEventTypesItem) {
  ...
  **/
  ...
  public HealthCheckTcp notificationTime(DictionaryItem notificationTime) {
  ...
  **/
  ...
  public HealthCheckTcp locationsFailoverEnabled(Boolean locationsFailoverEnabled) {
  ...
  **/
  ...
  public HealthCheckTcp errorTolerance(Integer errorTolerance) {
  ...
  **/
  ...
  public HealthCheckTcp id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckTcp interval(Integer interval) {
  ...
  **/
  ...
  public HealthCheckTcp name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckTcp address(String address) {
  ...
  **/
  ...
  public HealthCheckTcp serviceType(DictionaryItem serviceType) {
  ...
  **/
  ...
  public HealthCheckTcp state(DictionaryItem state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckTcp detailsLocation(String detailsLocation) {
  ...
  **/
  ...
  public HealthCheckTcp paused(Boolean paused) {
    this.paused = paused;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckTcp suspended(Boolean suspended) {
  ...
  **/
  ...
  public HealthCheckTcp lastInvalidCheck(OffsetDateTime lastInvalidCheck) {
  ...
  **/
  ...
  public HealthCheckTcp lastValidCheck(OffsetDateTime lastValidCheck) {
  ...
  **/
  ...
  public void setLastValidCheck(OffsetDateTime lastValidCheck) {
    ...
    public HealthCheckTcp description(String description) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HealthCheckTcp healthCheckTcp = (HealthCheckTcp) o;
    return Objects.equals(this.port, healthCheckTcp.port) &&
        Objects.equals(this.timeout, healthCheckTcp.timeout) &&
        Objects.equals(this.notificationTypes, healthCheckTcp.notificationTypes) &&
        Objects.equals(this.notificationEventTypes, healthCheckTcp.notificationEventTypes) &&
        Objects.equals(this.notificationTime, healthCheckTcp.notificationTime) &&
        Objects.equals(this.locationsFailoverEnabled, healthCheckTcp.locationsFailoverEnabled) &&
        Objects.equals(this.errorTolerance, healthCheckTcp.errorTolerance) &&
        Objects.equals(this.id, healthCheckTcp.id) &&
        Objects.equals(this.interval, healthCheckTcp.interval) &&
        Objects.equals(this.name, healthCheckTcp.name) &&
        Objects.equals(this.address, healthCheckTcp.address) &&
        Objects.equals(this.serviceType, healthCheckTcp.serviceType) &&
        Objects.equals(this.state, healthCheckTcp.state) &&
        Objects.equals(this.detailsLocation, healthCheckTcp.detailsLocation) &&
        Objects.equals(this.paused, healthCheckTcp.paused) &&
        Objects.equals(this.suspended, healthCheckTcp.suspended) &&
        Objects.equals(this.lastInvalidCheck, healthCheckTcp.lastInvalidCheck) &&
            Objects.equals(this.lastValidCheck, healthCheckTcp.lastValidCheck) &&
            Objects.equals(this.description, healthCheckTcp.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class HealthCheckTcp {\n");
