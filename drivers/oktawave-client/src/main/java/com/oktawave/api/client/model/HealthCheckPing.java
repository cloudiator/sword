...
public class HealthCheckPing {
  ...
  **/
  ...
  public HealthCheckPing replyTimeout(Integer replyTimeout) {
  ...
  **/
  ...
  public HealthCheckPing notificationTypes(List<DictionaryItem> notificationTypes) {
    this.notificationTypes = notificationTypes;
    return this;
  }

  public HealthCheckPing addNotificationTypesItem(DictionaryItem notificationTypesItem) {
  ...
  **/
  ...
  public HealthCheckPing notificationEventTypes(List<DictionaryItem> notificationEventTypes) {
    this.notificationEventTypes = notificationEventTypes;
    return this;
  }

  public HealthCheckPing addNotificationEventTypesItem(DictionaryItem notificationEventTypesItem) {
  ...
  **/
  ...
  public HealthCheckPing notificationTime(DictionaryItem notificationTime) {
  ...
  **/
  ...
  public HealthCheckPing locationsFailoverEnabled(Boolean locationsFailoverEnabled) {
  ...
  **/
  ...
  public HealthCheckPing errorTolerance(Integer errorTolerance) {
  ...
  **/
  ...
  public HealthCheckPing id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckPing interval(Integer interval) {
  ...
  **/
  ...
  public HealthCheckPing name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckPing address(String address) {
  ...
  **/
  ...
  public HealthCheckPing serviceType(DictionaryItem serviceType) {
  ...
  **/
  ...
  public HealthCheckPing state(DictionaryItem state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckPing detailsLocation(String detailsLocation) {
  ...
  **/
  ...
  public HealthCheckPing paused(Boolean paused) {
    this.paused = paused;
    return this;
  }
  ...
  **/
  ...
  public HealthCheckPing suspended(Boolean suspended) {
  ...
  **/
  ...
  public HealthCheckPing lastInvalidCheck(OffsetDateTime lastInvalidCheck) {
  ...
  **/
  ...
  public HealthCheckPing lastValidCheck(OffsetDateTime lastValidCheck) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HealthCheckPing healthCheckPing = (HealthCheckPing) o;
    return Objects.equals(this.packageSize, healthCheckPing.packageSize) &&
        Objects.equals(this.replyTimeout, healthCheckPing.replyTimeout) &&
        Objects.equals(this.notificationTypes, healthCheckPing.notificationTypes) &&
        Objects.equals(this.notificationEventTypes, healthCheckPing.notificationEventTypes) &&
        Objects.equals(this.notificationTime, healthCheckPing.notificationTime) &&
        Objects.equals(this.locationsFailoverEnabled, healthCheckPing.locationsFailoverEnabled) &&
        Objects.equals(this.errorTolerance, healthCheckPing.errorTolerance) &&
        Objects.equals(this.id, healthCheckPing.id) &&
        Objects.equals(this.interval, healthCheckPing.interval) &&
        Objects.equals(this.name, healthCheckPing.name) &&
        Objects.equals(this.address, healthCheckPing.address) &&
        Objects.equals(this.serviceType, healthCheckPing.serviceType) &&
        Objects.equals(this.state, healthCheckPing.state) &&
        Objects.equals(this.detailsLocation, healthCheckPing.detailsLocation) &&
  ...
  public String toString() {
    ...
    sb.append("class HealthCheckPing {\n");
