...
public class ApiCollectionInstanceStatistics {
  ...
  public ApiCollectionInstanceStatistics items(List<InstanceStatistics> items) {
    this.items = items;
    return this;
  }

  public ApiCollectionInstanceStatistics addItemsItem(InstanceStatistics itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<InstanceStatistics>();
    }
  ...
  **/
  ...
  public void setItems(List<InstanceStatistics> items) {
    this.items = items;
  }
