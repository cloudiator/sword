...
public class ThrowingSwordOverthereConnection implements SwordOverthereConnection {
    ...
    @Override public OperatingSystemFamily getHostOperatingSystem() throws RemoteException {
        return callAndRethrowAsRemoteException(overthereConnection::getHostOperatingSystem);
    }

    @Override public OverthereFile getFile(String hostPath) throws RemoteException {
        return callAndRethrowAsRemoteException(() -> overthereConnection.getFile(hostPath));
    }

    @Override public OverthereFile getFile(OverthereFile parent, String child)
        throws RemoteException {
        return callAndRethrowAsRemoteException(() -> overthereConnection.getFile(parent, child));
    }

    @Override public OverthereFile getTempFile(String nameTemplate) throws RemoteException {
        return callAndRethrowAsRemoteException(() -> overthereConnection.getTempFile(nameTemplate));
    }

    @Override public OverthereFile getTempFile(String prefix, String suffix)
        throws RemoteException {
        return callAndRethrowAsRemoteException(
            () -> overthereConnection.getTempFile(prefix, suffix));
    }

    @Override public OverthereFile getWorkingDirectory() throws RemoteException {
        return callAndRethrowAsRemoteException(overthereConnection::getWorkingDirectory);
    }

    @Override public void setWorkingDirectory(OverthereFile workingDirectory)
        throws RemoteException {
    ...
    @Override public int execute(CmdLine commandLine) throws RemoteException {
        return callAndRethrowAsRemoteException(() -> overthereConnection.execute(commandLine));
    }

    @Override public int execute(OverthereExecutionOutputHandler stdoutHandler,
    ...
    @Override public OverthereProcess startProcess(CmdLine commandLine) throws RemoteException {
        return callAndRethrowAsRemoteException(() -> overthereConnection.startProcess(commandLine));
    }

    @Override public boolean canStartProcess() {
