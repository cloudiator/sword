 ...
 */
public class JCloudsComputeService extends BaseComputeService {

    @Inject
    public JCloudsComputeService(Supplier<Set<? extends Image>> imageSupplier, Supplier<Set<? extends Location>> locationSupplier, Supplier<Set<? extends HardwareFlavor>> hardwareFlavorSupplier) {
