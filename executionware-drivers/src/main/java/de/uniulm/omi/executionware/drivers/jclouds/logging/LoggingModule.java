...
package de.uniulm.omi.executionware.drivers.jclouds.logging;
...
public class LoggingModule extends org.jclouds.logging.config.LoggingModule {
    ...
    private static class DelegateLoggerFactory implements Logger.LoggerFactory {
        ...
        private final de.uniulm.omi.executionware.api.logging.LoggerFactory delegateLoggerFactory;

        private DelegateLoggerFactory(de.uniulm.omi.executionware.api.logging.LoggerFactory deleteLoggerFactory) {
    ...
    private static class DelegateLogger extends BaseLogger {
        ...
        private final de.uniulm.omi.executionware.api.logging.Logger delegateLogger;
        private final String category;

        private DelegateLogger(de.uniulm.omi.executionware.api.logging.Logger delegateLogger, String category) {
